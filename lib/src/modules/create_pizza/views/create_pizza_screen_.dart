  ...
  Widget build(BuildContext context) {
    return BlocListener<CreatePizzaBloc, CreatePizzaState>(
      ...
      child: BlocListener<UploadPictureBloc, UploadPictureState>(
        listener: (context, state) {
          if (state is UploadPictureLoading) {} else
                      ...
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          setState(() {
                            ...
                            pizza.discount = int.parse(
                              discountController.text,
                            );
                            pizza.macros.calories = int.parse(
                              calorieController.text,
                            );
                            pizza.macros.proteins = int.parse(
                              proteinController.text,
                            );
                            pizza.macros.fat = int.parse(
                              fatController.text,
                            );
                            pizza.macros.carbs = int.parse(
                              carbsController.text,
                            );
                          });
                          print(pizza.toString());
                          context.read<CreatePizzaBloc>().add(
                            CreatePizza(pizza),
                          );
                        }
                      },
